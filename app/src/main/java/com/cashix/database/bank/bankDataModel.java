...
public class bankDataModel {
    ...
    String holdername, bankname, bankifsc, accountnumber, user;

    public bankDataModel(String holdername, String bankname, String bankifsc, String accountnumber, String user) {
